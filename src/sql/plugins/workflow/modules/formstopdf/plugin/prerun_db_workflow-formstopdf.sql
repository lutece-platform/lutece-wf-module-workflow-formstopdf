...
--
-- Pre-execution script of the module (LUT-33342 ; plugin-liquibase >= 1.0.2, LUT-33327) : executed in the
...
--
-- Rename workflow-formspdf -> workflow-formstopdf (LUT-32273, LUT-33288) : on an existing site
